...
"""
TXT Batch Downloader with Rate Limiting

Downloads a series of numbered TXT files with polite rate limiting
to respect the server.

Usage:
    uv run download_txt.py
"""
...
BASE_URL = "https://www.grc.com/sn/sn-{num:03d}.txt"
...
def main():
    ...
    logging.info("=" * 60)
    logging.info("Starting TXT download batch")
